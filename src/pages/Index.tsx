...
const initialThoughts = [
  {
    ...
    content:
      "What if everyone who reads this post sends me just $1? I wonder how much would be collected in a month for my small business idea...",
  ...
  },
  {
    ...
    content:
      "Today I came up with a startup, but I need support. If you like the idea of an educational platform for children from low-income families, send a symbolic dollar as a sign of support!",
  ...
  },
  {
    ...
    content:
      "One dollar is nothing for everyone, but together we can do a lot. Starting a fundraiser to buy food for a homeless animal shelter in our area. Every $1 helps!",
...
const featuredChallenge = {
  ...
  description:
    "Launch a small business with a minimal budget. Document your journey and get boosted!",
            ...
            <Button
              ...
              onClick={() => {
                toast({
                  title: "Создание цели",
                  description:
                    "Функция создания цели будет доступна в ближайшее время",
                });
              }}
            >
