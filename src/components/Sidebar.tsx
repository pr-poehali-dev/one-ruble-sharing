...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <>
          ...
          <div className="flex h-full flex-col">
            <div className="flex items-center px-2 py-4">
              ...
              <span className="font-bold text-xl">
                Coin<span className="text-primary">Boost</span>
              </span>
            </div>
      ...
      <div
        className={cn(
          "hidden h-screen md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 z-30",
          className,
        )}
      >
            ...
            <div className="p-3 mt-4">
              <div className="rounded-lg bg-gradient-to-r from-violet-500 to-blue-500 p-4 text-white">
                ...
                <p className="text-sm opacity-90 mb-2">
                  Unlock more features and boost exposure
                </p>
                <Button
                  size="sm"
                  variant="secondary"
